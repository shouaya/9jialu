...
{
    //数据库表
    const db_table = "session"; //需要第三方指定数据表
    ...
    function open($savePath, $sessName) 
    {
        ...
        $db_handle = @mysql_connect(SAE_MYSQL_HOST_M.':'.SAE_MYSQL_PORT,SAE_MYSQL_USER,SAE_MYSQL_PASS);

        $dbSel = @mysql_select_db(SAE_MYSQL_DB, $db_handle);
 ...
 */
define("MAIN_DOMAIN", ".9jialu.com");   //设置主域名
